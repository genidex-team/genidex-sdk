import { BigNumberish, getBigInt, Contract, ErrorDescription, getAddress, Interface, isAddress, Signer } from "ethers";
...
export class GeniDexCore {
     ...
     */
    async getTokenMeta(tokenAddress: string): Promise<TokenInfo | any> {
     ...
     */
    revertError(err: any, functionName: string, args?: any[]) {
     ...
     */
    mapArgsToObject(abi: any, methodName: string, args: any[]): Record<string, any> {
